...
import { PasswordForgetComponent, PasswordForgetService, MessageService } from "./components/password-forget";
...
@NgModule({
  ...
  providers: [
    SubscriberService, SubscriberViewService, PasswordForgetService, PasswordResetService, MessageService
  ]
})
