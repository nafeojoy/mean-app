...
export class LoginComponent {
    ...
    constructor(private baseService: BaseService, public authService: AuthService, private router: Router, private _customCookieService: CustomCookieService,
        private location: Location, private _cookieService: CookieService, private pubSubService: PubSubService, private messageService: MessageService) {
        router.events
